...
local Window = Rayfield:CreateWindow({
   ...
   Discord = {
      ...
      Invite = "discord.gg/77PM
      K", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
...
Rayfield:Notify({
   ...
   Duration = 5,
   Image = 13047715178,
   Actions = "77PK" -- Notification Buttons
      Ignore = {
         Name = "Okay!",
         Callback = function()
...
local SPAWNGUNTab = Window:CreateTab("🔫DUPE GUN BY MOON POGI🔫", 4483362458) -- Title, Image
